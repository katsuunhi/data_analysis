...
def save_to_txt():
    for i in range(1,101):
        ...
        print("开始保存第%d页" % i)
        url = 'http://m.maoyan.com/mmdb/comments/movie/346178.json?_v_=yes&offset=' + str(i)

        html = get_one_page(url)
        for item in parse_one_page(html):
            with open('the_meg.txt','a',encoding='utf-8') as f:
...
if __name__ == '__main__':
    save_to_txt()
    delete_repeat(r'the_meg_old.txt',r'the_meg_new.txt')