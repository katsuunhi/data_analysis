...
def save_to_txt():
    for i in range(1,101):
        ...
        print("开始保存第%d页" % i)
        url = 'http://m.maoyan.com/mmdb/comments/movie/1203084.json?_v_=yes&offset=' + str(i)

        html = get_one_page(url)
        for item in parse_one_page(html):
            with open('一出好戏.txt','a',encoding='utf-8') as f:
...
if __name__ == '__main__':
    save_to_txt()
    delete_repeat(r'一出好戏_old.txt',r'一出好戏_new.txt')