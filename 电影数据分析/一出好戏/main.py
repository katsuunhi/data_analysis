...
f = open('一出好戏.txt',encoding='utf-8')
...
geo = Geo("《一出好戏》粉丝人群地理位置","数据来源：恋习Python",**style.init_style)
...
#导入背景图
backgroud_Image = plt.imread('huangbo.jpg') 
